import { ApplicationRef, DoBootstrap, EnvironmentProviders, NgModule, Provider, Type } from "@angular/core";
import { ApplicationConfig, BrowserModule, platformBrowser } from "@angular/platform-browser";
